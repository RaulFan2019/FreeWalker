...
public class SuperTagGroup extends ViewGroup {
    ...
    public SuperTagGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textColor = ta.getColor(R.styleable.SuperTagGroup_tag_text_color, SuperTagUtil.DEFAULT_TAG_TV_COLOR);
        textCheckedColor = ta.getColor(R.styleable.SuperTagGroup_tag_text_checked_color, SuperTagUtil.DEFAULT_TAG_TV_CHECKED_COLOR);
        ...
        tagBgColor = ta.getColor(R.styleable.SuperTagGroup_tag_bg_color, SuperTagUtil.DEFAULT_TAG_BG_COLOR);
        tagBgCheckedColor = ta.getColor(R.styleable.SuperTagGroup_tag_bg_checked_color, SuperTagUtil.DEFAULT_TAG_BG_CHECKED_COLOR);
