...
public class SuperTagView extends android.support.v7.widget.AppCompatTextView implements Checkable {
    ...
    public SuperTagView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        borderCheckedColor = ta.getColor(R.styleable.SuperTagView_border_checked_color, SuperTagUtil.DEFAULT_TAG_BORDER_CHECKED_COLOR);
        bgCheckedColor = ta.getColor(R.styleable.SuperTagView_bg_checked_color, SuperTagUtil.DEFAULT_TAG_BG_CHECKED_COLOR);
...
//        setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
    ...
    private void applyITag() {
        if (iTag != null) {
            ...
            setTextColor(SuperTagUtil.DEFAULT_TAG_TV_COLOR);

            if (isChecked){
                setTextColor(SuperTagUtil.DEFAULT_TAG_TV_CHECKED_COLOR);
            }else {
                setTextColor(SuperTagUtil.DEFAULT_TAG_TV_COLOR);
            }
...
//            }
            setBgColor(SuperTagUtil.DEFAULT_TAG_BG_COLOR);
...
//            }
            setBgCheckedColor(SuperTagUtil.DEFAULT_TAG_BG_CHECKED_COLOR);
